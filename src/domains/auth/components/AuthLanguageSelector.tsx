  ...
  return (
    <div className="fixed top-6 right-6 z-50" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 text-sm font-medium text-gray-700 dark:text-gray-300 shadow-lg"
        aria-label="Escolher idioma"
      >
        <span className="text-lg">{currentLang?.flag || '🌐'}</span>
        <span className="hidden sm:inline">{currentLang?.name || 'Português'}</span>
        <svg
      ...
      {isOpen && (
        <div className="absolute top-full mt-2 right-0 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg shadow-xl min-w-[180px] z-50">
          <div className="p-2">
